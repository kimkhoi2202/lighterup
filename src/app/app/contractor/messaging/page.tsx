...
export default function ContractorMessagingPage() {
  ...
  const otherPartyName = selectedConversation?.homeowner
    ? selectedConversation.homeowner.full_name || "Unknown Homeowner"
            ...
            <>
              ...
              <div className="flex-1 flex flex-col min-h-0">
                <ChatWindow
                  ...
                  currentUserId={currentUserId}
                  otherPartyName={selectedConversation?.homeowner?.full_name}
